...
<div class="admin-panel">
    ...
    <div class="flex flex-col">
        <div class="form-group">
            ...
            <form method="POST" action="?/addAlbum" enctype="multipart/form-data" use:enhance class="flex flex-col input-group">
                ...
                <input type="text" name="totalTracks" placeholder="number of tracks" required />
